            ...
            if line != "":
                ...
                if jishokei in IndexGroup:
                    dichtml = r'<section class="description"><a href="entry://' + \
                        jishokei+r'#description">'+jishokei+'</a>\n</section>\n</>'+'\n'
