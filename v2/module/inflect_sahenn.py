...
def InflectSahenn():
    with open(r"index\sahenn.txt",
        ...
        for line in InputFile:
            ...
            if r'する' in line:
                line_1 = line[0:-3] + \
                    line[-3:-1].replace("する", "し" + '\n')+dichtml
                line_2 = line[0:-3] + \
                    line[-3:-1].replace("する", "せ" + '\n')+dichtml
                line_3 = line[0:-3] + \
                    line[-3:-1].replace("する", "さ" + '\n')+dichtml
                line_4 = line[0:-3] + \
                    line[-3:-1].replace("する", "すれ" + '\n')+dichtml
                line_5 = line[0:-3] + \
                    line[-3:-1].replace("する", "しろ" + '\n')+dichtml
                line_6 = line[0:-3] + \
                    line[-3:-1].replace("する", "せよ" + '\n')+dichtml
                line_7 = line[0:-3] + \
                    line[-3:-1].replace("する", "そ" + '\n')+dichtml
                OutputFile.write(line_1+line_2+line_3 +
                                 line_4+line_5+line_6+line_7)
            elif r'ずる' in line:
                line_1 = line[0:-3] + \
                    line[-3:-1].replace("ずる", "じ" + '\n')+dichtml
                line_2 = line[0:-3] + \
                    line[-3:-1].replace("ずる", "ぜ" + '\n')+dichtml
                line_3 = line[0:-3] + \
                    line[-3:-1].replace("ずる", "ずれ" + '\n')+dichtml
                line_4 = line[0:-3] + \
                    line[-3:-1].replace("ずる", "じる" + '\n')+dichtml
                line_5 = line[0:-3] + \
                    line[-3:-1].replace("ずる", "じろ" + '\n')+dichtml
                line_6 = line[0:-3] + \
                    line[-3:-1].replace("ずる", "じよ" + '\n')+dichtml
                line_7 = line[0:-3] + \
                    line[-3:-1].replace("ずる", "ぜよ" + '\n')+dichtml
                OutputFile.write(line_1+line_2+line_3 +
                                 line_4+line_5+line_6+line_7)
            elif r'す' in line:
