前排说明：这个版本目前需要和 Android 端的一款自动化软件 Auto.js 配合使用，iOS 端的同学就不要照本宣科了。另外，上手难度（可能）非常大，实际体验也比较一言难尽，请先仔细阅读本文档，确认自己有能力、有时间、有需要再动手遇到问题可以到 GitHub 处留言，或者通过 NoHeartPen@outlook.com 与我联系。
